    ...
    <RouterTabs
      ...
      <RouterTabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <SymbolView
              name={{ ios: 'wallet.pass.fill', android: 'account_balance_wallet' }}
              size={size}
              tintColor={color}
            />
          ),
      ...
      <RouterTabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <SymbolView
              name={{ ios: 'arrow.left.arrow.right.circle.fill', android: 'swap_horiz' }}
              size={size}
              tintColor={color}
            />
          ),
      ...
      <RouterTabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <SymbolView
              name={{ ios: 'square.grid.3x3.topleft.filled', android: 'category' }}
              size={size}
              tintColor={color}
            />
          ),
